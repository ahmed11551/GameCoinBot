...
⚠️ <b>Важно:</b> Все игры используют виртуальную валюту и предназначены только для развлечения!`, { 
        parse_mode: 'HTML',
        reply_markup: {
          inline_keyboard: [
            [
            ...
            [
              { text: '⚖️ Правовая информация', callback_data: 'legal_info' }
            ],
            [
              { text: '🔙 Главное меню', callback_data: 'main_menu' }
            ]
...
Платеж отменен. Вы можете попробовать снова или выбрать другой способ оплаты.', {
    ...
    case 'legal_acknowledged':
      ctx.answerCbQuery('✅ Спасибо за понимание!');
      ctx.editMessageText(`⚖️ <b>Правовая информация</b>

✅ <b>Вы подтвердили понимание правил</b>

🎰 <b>Важно помнить:</b>
• Все игры используют виртуальную валюту
• Нет прямого обмена на реальные деньги
• Игры предназначены только для развлечения
• Играйте ответственно!

🔒 <b>Ваши права:</b>
• Полная прозрачность игрового процесса
...
💡 <b>Нужна помощь?</b> Обратитесь в поддержку!`, {
    ...
    case 'legal_decline':
      ctx.answerCbQuery('❌ Вы не согласны с правилами');
      ctx.editMessageText(`❌ <b>Отказ от согласия</b>

Вы не согласились с правилами использования бота.

🚫 <b>Ограничения:</b>
• Доступ к азартным играм заблокирован
• Доступ к покупкам ограничен
• Некоторые функции недоступны

💡 <b>Что делать:</b>
• Прочитайте правила внимательно
• Обратитесь в поддержку с вопросами
• Примите правила для полного доступа

📞 <b>Поддержка:</b> @new_coinmaster_game_bot`, {
        parse_mode: 'HTML',
        reply_markup: {
          inline_keyboard: [
            [
              { text: '📋 Прочитать правила', callback_data: 'legal_info' }
            ],
            [
              { text: '🔙 Главное меню', callback_data: 'main_menu' }
            ]
